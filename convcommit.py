...
def verbose_echo(message: str, verbose: bool = False) -> None:
...
@click.option('--verbose', '-v', is_flag=True, default=os.getenv("VERBOSE", "false").lower() == "true", help="Enable verbose output")
def main(
